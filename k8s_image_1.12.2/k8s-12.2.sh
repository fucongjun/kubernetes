...
echo "删除原有镜像"
docker image rm mirrorgooglecontainers/kube-apiserver-amd64:v1.12.2
docker image rm mirrorgooglecontainers/kube-controller-manager-amd64:v1.12.2
docker image rm mirrorgooglecontainers/kube-scheduler-amd64:v1.12.2
docker image rm mirrorgooglecontainers/kube-proxy-amd64:v1.12.2
